...
Ext.define('Ext.calendar.form.Form', {
    ...
    consumeEventData: function() {
        var me = this,
            ...
            view = me.getView(),
            event = me.getEvent(),
            startDate = view.utcToLocal(event.getStartDate()),
            endDate = view.utcToLocal(event.getEndDate()),
    ...
    produceEventData: function(values) {
        ...
        if (values.allDay) {
            ...
            startDate = view.toUtcOffset(sYear, sMonth, sDate, startTime.getHours(), startTime.getMinutes());
            endDate = view.toUtcOffset(eYear, eMonth, eDate, endTime.getHours(), endTime.getMinutes());
        }
